...
export default defineConfig({
  ...
  '/projects/japanese-songs': '/projects/japanese-song-directory',
  '/projects/歌詞解析目錄': '/projects/japanese-song-directory',
  '/projects/日文歌學習': '/projects/japanese-song-directory',
