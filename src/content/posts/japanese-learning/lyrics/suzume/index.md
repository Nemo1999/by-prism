...
description: "《鈴芽之旅》主題曲《すずめ》完整歌詞、逐句解析與相關單字文法。重點學習日文動詞變化規則。"
pubDate: 2026-05-01
author: 小波
tags: ["すずめ", "RADWIMPS", "十明", "鈴芽之旅", "歌詞", "日文學習", "動詞變化", "發音功能"]
draft: false
featured: true
---
...
> 新海誠《鈴芽之旅》(すずめの戸締まり) 主題曲。透過這首歌學習日文動詞變化規則：五段動詞、一段動詞、不規則動詞的各種活用形。

## 🎵 完整歌詞

### 第一段

1. [[posts/japanese-learning/lyrics/suzume/suzume-kimi-no-naka|君の中にある 赤と青き線]] <button class="pronunciation-play-btn" data-text="君の中にある赤と青き線">🔊</button>
...
- [[posts/japanese-learning/grammar/verb-conjugation|日文動詞變化規則 — 完整基礎]] — 五段・一段・不規則動詞、て形・た形・ない形・辞書形

## 📝 相關單字

- [[posts/japanese-learning/vocabulary/tojiru|閉じる（とじる）]] — 關閉（一段動詞）
- [[posts/japanese-learning/vocabulary/shimeru|閉める（しめる）]] — 關上（五段動詞）
- [[posts/japanese-learning/vocabulary/musubu|結ぶ（むすぶ）]] — 連結、締結（五段動詞）
- [[posts/japanese-learning/vocabulary/akeru|開ける（あける）]] — 打開（一段動詞）

## 🎬 關於這首歌

- **歌手**：RADWIMPS feat. 十明（とあか）
- **電影**：すずめの戸締まり（鈴芽之旅，2022）
- **導演**：新海誠
- **特點**：歌詞中大量使用「閉じる」「開ける」等動作動詞，是學習動詞變化的絕佳教材
